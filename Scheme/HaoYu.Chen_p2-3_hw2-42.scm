...
#reader(lib "htdp-advanced-reader.ss" "lang")((modname HaoYu.Chen_p2-3_hw2-42) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #t #t none #f () #f)))
;Hao Yu Chen
;IntroCS1 PD3
;HW42 - sentence what?
; 2016 - 05 - 04
;umuuu this was the closest i got
...
(define noun-phrase (lambda () 
                      (append  (list Articles) (list Adjective) (list Noun))))
(define verb-phrase (lambda ()

                      
                      (append (list Verb) (list Noun) (list Adverbs))))
